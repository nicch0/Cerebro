<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				default: "bg-interactive-accent text-on-accent hover:bg-opacity-100 hover:bg-interactive-accent-hover hover:text-on-accent shadow",
				...
				// Defaults
				destructive:
					"bg-modifier-error text-normal hover:bg-destructive/90 shadow-sm",
